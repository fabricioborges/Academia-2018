...
GO
PRINT N'Criando [dbo].[FK_usuario]...';


GO
ALTER TABLE [dbo].[TBSala]
    ADD CONSTRAINT [FK_usuario] FOREIGN KEY ([Usuario_id]) REFERENCES [dbo].[TBUsuario] ([Id_usuario]);
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'e3f530ff-cf7d-4556-aefb-c3fb497c01b5')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('e3f530ff-cf7d-4556-aefb-c3fb497c01b5')
